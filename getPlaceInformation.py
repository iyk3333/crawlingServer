...
def placeInfo():
    ...
    with open('program_list.txt', 'r', encoding='utf-8') as tf:
                ...
                for i in range(1, 20):
                   ...
                   #  print('\n', i, '페이지입니다.\n')
                    ...
                    response = requests.get(
                        f'https://map.naver.com/v5/api/search?caller=pcweb&query={url_keyword}&type=all&page={i}&displayCount=40&lang=ko',
                        headers={
                    ...
                    for i in range(0, len(numbers)):
                        ...
                        place.append([name, address, tel, menuinfo])
